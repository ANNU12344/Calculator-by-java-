calculator by using Java Swing
package Calculator;
import javax.swing.*;
...
public class calc implements ActionListener 
{
	...
	JButton buttonReciporcal = new JButton("1/x");
	...
	public void addComponents() {
		...
		buttonReciporcal.setBounds(150,170,60,40);
		buttonReciporcal.setFont(new Font("Arial",Font.BOLD,15));
		buttonReciporcal.setBackground(new Color(239,188,2));
		buttonReciporcal.setFocusable(false);
		frame.add(buttonReciporcal);
	...
	public void addActionEvent() {
		...
		buttonReciporcal.addActionListener(this);
	...
	public void actionPerformed(ActionEvent e) {
		...
		else if(object==buttonReciporcal)
		{
			num1=Double.parseDouble(textField.getText());
	...
	public void enable()
	{
		...
		buttonReciporcal.setEnabled(true);
	...
	public void disable()
	{
		...
		buttonReciporcal.setEnabled(false);
